      ...
      <PoolProvider>
        <div className="home-main-container bg-white rounded-md mt-top">
          <div className="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div className="ml-left">⚡ <span className="text-gray-500">Bitcoin Lightning Address</span> : <span className="font-bold tracking-wide">babaji@satoshi</span>
             </div>
            <div>
            ...
            <div className="flex items-center justify-start">
              <div>
                <div>
                  <h3 className="ml-left mt-stakingpoolmargin text-lg font-semibold text-gray-500">Next Payout in:</h3>
                </div>
